...
@interface DemoViewControllerXib ()

@end

@implementation DemoViewControllerXib {
	NSInteger rows;
}

@synthesize scrollTable;
@synthesize numberOfColumnsLabel, numberOfRowsLabel, widthLabel;
